...
<<<<<<< HEAD
    ...
    <div class="alert alert-info alert-dismissible mt-5" role="alert">
       ...
       <strong style="text-align: center;color: darkred;"> <h3>Frequently Asked Questions  .</strong> </h3>
    </div>
        ...
        <div class="card ">
            <div class="card-header">
                <span class="card-header">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"><h3 style="font-weight: bold;font-size: 20px;">What are the options I can avail for editing?</h3></a>
                </span>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="card-block">
                   <strong>Welcome to <label for="" style="color: darkred; font-weight: bolder;">S</label><label for="" style="color: black;font-weight: bolder;">ci</label><label for="" style="color: darkred;font-weight: bolder;">P</label><label for="" style="color: black;font-weight: bolder;">ub</label> assistance service. Thanks for letting us know about your queries. Please find below the answer of your question. If it is still confused contact us directly by sending us an e-mail.
Dear customer, we offer editing services for articles, academic papers, etc. These include simple or multiple round editing, and standard editing. Moreover, there are proofreading services, technical reading and so on. Thank you!</strong>
        ...
        <div class="card ">
            <div class="card-header">
                <span class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTen"><h3 style="font-weight: bold;font-size: 20px;">Are your editors really qualified? </h3></a>
                </span>
            </div>
...
Dear customer, all our editors are active scientific researchers and academicians and have at least the PhD level. They are well versed in the international standards of academic appraisal and scientific publication. They have published each more than 50 articles in top journals. Some editors are even associated with reputed journals as peer review experts, and with leading institutes as consulting examiners. Thank you!</strong>
        ...
        <div class="card ">
            <div class="card-header">
                <span class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven"><h3 style="font-weight: bold;font-size: 20px;">Why should I choose your company? What are your offers? </h3></a>
                </span>
            </div>
...
Dear customer, there are numerous advantages offered by us. Our price, service guarantee, promptitude and flexibility make us the leader in this field. Thank you!</strong>
        ...
        <div class="card ">
            <div class="card-header">
                <span class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><h3 style="font-weight: bold;font-size: 20px;">What is the difference between your technical reading service and proofreading service?</h3></a>
                </span>
            </div>
...
Dear customer, a technical reading is an in-depth proofreading of a manuscript in a particular field. We only offer technical reading service in our specializations (plant biology, bioinformatics, biotechnology, etc). However, we offer proofreading service in all scientific fields. Thank you!</strong>
        ...
        <div class="card ">
            <div class="card-header">
                <span class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree"><h3 style="font-weight: bold;font-size: 20px;">What is the turnaround time I can expect a response from your team?</h3></a>
                </span>
            </div>
...
Dear customer, we will reply to your queries within hours during the working time. Send us an enquiry and our experts will be back to you at the earliest. Thank you!</strong>
        ...
        <div class="card ">
            <div class="card-header">
                <span class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive"><h3 style="font-weight: bold;font-size: 20px;">How many days will your submission service last?</h3></a>
                </span>
            </div>
...
Dear customer, the submission service doesn’t last more than two working days.</strong>
        ...
        <div class="card ">
            <div class="card-header">
                <span class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix"><h3 style="font-weight: bold;font-size: 20px;">Can I have a multi-omics database development service? Is it expensive?</h3></a>
                </span>
            </div>
...
Dear customer, Yes you can. That service is available. It is not expensive. Please contact us. Thank you!</strong>
        ...
        <div class="card ">
            <div class="card-header">
                <span class="card-header">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEight"><h3 style="font-weight: bold;font-size: 20px;">Is your NGS data analysis service still available?</h3></a>
                </span>
            </div>
...
=======
        <section id="faq" class="faq wow fadeInUp ">
            <div class="container ">
                <header class="section-header" style="margin-top: 120px;">
                ...
                <ul id="faq-list " class="wow fadeInUp ">
                    <li class="mb-2">
                        ...
                        <div id="faq1" class="collapse" data-parent="#faq-list">
                            <p>
                                Welcome to <label for="" style="color: darkred; font-weight: bolder;">S</label><label for="" style="color: black;font-weight: bolder;">ci</label><label for="" style="color: darkred;font-weight: bolder;">P</label><label for="" style="color: black;font-weight: bolder;">ub</label> assistance service. Thanks for letting us know about your queries. Please find below the answer of your question. If it is still confused contact us directly by sending us an e-mail.
                            </p>
                            <p>
                    ...
                    <li class="mb-2">
                        <h6 id="question7" class="question">Can I have a multi-omics database development service? Is it expensive?<i class="ion-android-remove "></i></h6>
                    ...
                    <li class="mb-2">
                        <h6 id="question8" class="question">Is your NGS data analysis service still available?<i class="ion-android-remove "></i></h6>
