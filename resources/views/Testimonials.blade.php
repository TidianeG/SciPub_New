                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
                        <div class="box">
                            ...
                            <p style="text-align: justify;" class="description">
                                <label for="" style="color: darkred; font-weight: bolder;">S</label><label for="" style="color: black;font-weight: bolder;">ci</label><label for="" style="color: darkred;font-weight: bolder;">P</label>
                    ...
                    <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
                        <div class="box">
                            ...
                            <p style="text-align: justify;" class="description">
                                ...
                                <label for="" style="color: darkred; font-weight: bolder;">S</label><label for="" style="color: black;font-weight: bolder;">ci</label><label for="" style="color: darkred;font-weight: bolder;">P</label>
                                <label for="" style="color: black;font-weight: bolder;">ub</label>'s services .</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
                        <div class="box">
                            ...
                            <p style="text-align: justify;" class="description">
                                 They handled my paper confidentially and quickly published it in a top journal. I recommend this company.</p>
                        </div>
                    </div>
